-- Update handle_new_user function to restore original positions for 立石 and 松下
...
BEGIN
  ...
  VALUES
    (NEW.id, '立石 正広', '創価大学', '三塁手/二塁手', '大学', ARRAY['1位競合'], ARRAY[]::text[], 2025, '右打', '右投', '', NULL, '', '', ARRAY[]::text[], '三塁手'),
    (NEW.id, '松下 歩叶', '法政大学', '二塁手/三塁手/遊撃手', '大学', ARRAY['1位一本釣り', '外れ1位'], ARRAY[]::text[], 2025, '右打', '右投', '', NULL, '', '', ARRAY[]::text[], '三塁手'),
